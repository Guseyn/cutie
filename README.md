# Cutie
Cutie is lightweight library without any external dependencies, the main point of which is just to provide user with one abstraction: <b>AsyncObject</b> that makes your asynchronous code in Node simple and declarative and that's it.
